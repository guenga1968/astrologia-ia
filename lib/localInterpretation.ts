...
const JUPITER_SIGN_INTERPRETATIONS: Record<string, string> = {
    ...
    'Cáp': 'Júpiter en Cancer te hace optimista emocionalmente. Encontrás crecimiento a través de la familia y lo nurturante.',
...
const SATURN_SIGN_INTERPRETATIONS: Record<string, string> = {
    ...
    'Cáp': 'Saturno en Cancer testa tu seguridad emocional. Aprendés a construir un hogar sólido sobre bases firmes.',
